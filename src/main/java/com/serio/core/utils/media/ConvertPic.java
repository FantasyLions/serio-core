...
public class ConvertPic {
	...
	protected static Logger logger = LoggerFactory.getLogger(ConvertPic.class);
 /**
  * @param sSourceImage
  * 源文件完整路径
  * @param sDestImage
  ...
  */
	...
	private static boolean IsUsableType(String imgType) {
	  if ("jpg".equalsIgnoreCase(imgType) || "jpeg".equalsIgnoreCase(imgType) || "png".equalsIgnoreCase(imgType) || "gif".equalsIgnoreCase(imgType))
	    return true;
	  return false;
	}
...
//    	 * @param srcImg 源Img
//    	 * @param destPathSmall 压缩后小图路径
//    	 * @param width,height 压缩尺寸
...
//    	 */ 
	private static void convert(String srcPath, String destPathSmall, String type) throws Exception {
		...
		logger.info(" width is : "+width + " height is : "+height + " iWidth is : "+iWidth + " iHeight is : "+iHeight);
	 ...
	 /**
	   ...
	   * @throws IOException
	   */
	  private static void resize(File inputFile, String outputImagePath, int scaledWidth,
	   ...
	   * @throws IOException
	   */
	  private static void resize(String inputImagePath, String outputImagePath, int scaledWidth,
	      int scaledHeight) throws IOException {
	    // reads input image
...
//	   * @param inputImagePath Path of the original image
//	   * @param outputImagePath Path to save the resized image
//	   * @param scaledValue absolute width/height in pixels
//	   * @param bHeight true:scaledValue is height value
//	   * @throws IOException
//	   */
//	  public static void resize(String inputImagePath, String outputImagePath, int scaledValue,
//	      boolean bHeight) throws IOException {
//	    File inputFile = new File(inputImagePath);
//	    BufferedImage inputImage = ImageIO.read(inputFile);
//
...
//	    int scaledHeight = 0;
//	    if (bHeight) {
//	      scaledWidth = scaledValue * width / height;
//	      scaledHeight = scaledValue;
//	    } else {
//	      scaledHeight = scaledValue * height / width;
